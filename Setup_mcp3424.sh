...
for address in $addresses;do
    ...
    sudo chown pi /sys/bus/i2c/devices/1-00${address}/iio\:device*/*
    ...
    for port in {0..3};do
        v=$(echo $(cat /sys/bus/i2c/devices/1-00${address}/iio:device*/in_voltage${port}_raw)*$(cat /sys/bus/i2c/devices/1-00${address}/iio:device*/in_voltage${port}_scale)|bc -l)
